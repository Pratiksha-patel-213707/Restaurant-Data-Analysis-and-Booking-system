...

{
    ...
    if($id % 2 ==1 )
    {
        ...
        <td><a href=printbooktable1.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
...
if($id % 2 ==1 )
{
    ...
    <td> ".$row['spname']." </td>
    <td> ".$row['table_size']." </td>
    <td><a href=printbooktable2.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
    <td><a href=abidsdeleterecord.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>	    
    </tr>";
        }
else
...
if($id % 2 ==1 )
{
    ...
    <td> ".$row['spname']." </td>
    <td> ".$row['table_size']." </td>
    <td><a href=printbooktable3.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
    <td><a href=abidsdeleterecord.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>	    
    </tr>";
        }
else
...
if($id % 2 ==1 )
{
  ...
  <td> ".$row['spname']." </td>
  <td> ".$row['table_size']." </td>
  <td><a href=printbooktable4.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
  <td><a href=abidsdeleterecord.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>	    
  </tr>";
      }
else
...
if($id % 2 ==1 )
{
    ...
    <td> ".$row['spname']." </td>
    <td> ".$row['table_size']." </td>
    <td><a href=printbooktable5.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
    <td><a href=abidsdeleterecord.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>	    
    </tr>";
        }
else
...
if($id % 2 ==1 )
{
    ...
    <td> ".$row['spname']." </td>
    <td> ".$row['table_size']." </td>
    <td><a href=printbooktable6.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
    <td><a href=abidsdeleterecord.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>	    
    </tr>";
        }
else
...
if($id % 2 ==1 )
{
    ...
    <td> ".$row['spname']." </td>
    <td> ".$row['table_size']." </td>
    <td><a href=printbooktable7.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
    <td><a href=abidsdeleterecord.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>	    
    </tr>";
        }
else
...
if($id % 2 ==1 )
{
    ...
    <td> ".$row['spname']." </td>
    <td> ".$row['table_size']." </td>
    <td><a href=printbooktable8.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
    <td><a href=abidsdeleterecord.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>	    
    </tr>";
        }
else
...
if($id % 2 ==1 )
{
    ...
    <td> ".$row['spname']." </td>
    <td> ".$row['table_size']." </td>
    <td><a href=printbooktable9.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
    <td><a href=abidsdeleterecord.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>	    
    </tr>";
        }
else
...
if($id % 2 ==1 )
{
    ...
    <td> ".$row['spname']." </td>
    <td> ".$row['table_size']." </td>
    <td><a href=printbooktable10.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
    <td><a href=abidsdeleterecord.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>	    
    </tr>";
        }
else
...
if($id % 2 ==1 )
{
    ...
    <td> ".$row['spname']." </td>
    <td> ".$row['table_size']." </td>
    <td><a href=printbooktable11.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
    <td><a href=abidsdeleterecord.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>	    
    </tr>";
        }
else
...
if($id % 2 ==1 )
{
    ...
    <td> ".$row['spname']." </td>
    <td> ".$row['table_size']." </td>
    <td><a href=printbooktable12.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
    <td><a href=abidsdeleterecord.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>	    
    </tr>";
        }
else
