                ...
                <div class="col-md-12">
...

										{
...

											{
												...
												echo"<tr class='gradeC'>
                                                    ...
                                                    <td><a href=usersettingdel.php?id=".$id." <button class='btn btn-primary'> <i class='fa fa-dekete' ></i> DELETE</button></td>
					...
					<div class="panel-body">
...

						{
							...
							$newsql ="Insert into admin_login (usname,pass) values ('$newus','$newps')";
