...
<body>
    ...
    <header>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-8">
                            ...
                            <div class="short_contact_list">
                                ...
                                <ul>    
                                    ...
                                    <li><a href="tel:+919752612222"></a></li>

                                    <!--<li><a href="#">Mon - Sat 10:00 - 8:00</a></li>-->
                        ...
                        <div class="col-lg-6 col-md-4 ">
                            ...
                            <div class="social_media_links">
                                ...
                                <a href="https://www.instagram.com/pawsdogplanet/">
        ...
        <ul id="navigation">
          ...
          <li><a href="demobooking/table.php">BOOKING</a></li>
          <!-- <li><a href="bookingh1/calender.php">NEW MARKET</a></li>

          <li><a href="bookingh2/calender.php">MP NAGAR</a></li>

          <li><a href="bookingh3/calender.php">KATARA HILLS</a></li> -->
