...
<label>Dish Select</label>

<select name="fdq"  class="form-control"  required>

<option value="no">blank</option>
              <option value="Masaladosa">Masaladosa</option>
            <option value="Pasta">Pasta</option>
            <option value="chole khulche">Chole Khulche</option>
            <option value="Pizza">Pizza</option>
            <option value="crishpy noodles">crishpy noodles</option>
...
<option value="85">Masaladosa price</option>
<option value="90">Pasta price</option>
<option value="150">Chole Khulche price</option>
<option value="200">Pizza price</option>
<option value="70">crishpy noodles price</option>
<option value="95">Fried Rice price</option>
<option value="65">Paratha price</option>
</select>                 
 </div>  
...
{			$newUser="INSERT INTO record2( custname, email, address, phone_no, totalamount, tip, gender, time, tablesize,age,day,fdquality) VALUES ('$_POST[fname]','$_POST[email_1]','$_POST[address]','$_POST[phone]','$_POST[total_amount]','$_POST[total_tip]','$_POST[sex]','$_POST[time]','$_POST[size]','$_POST[age_1]','$_POST[day]','$_POST[fdq]')";
