...
function build_calendar($month, $year) {
    ...
    $calendar.= " <a href='calendertable3.php' class='btn btn-xs btn-warning' data-month='".date('m')."' data-year='".date('Y')."'>Current Month</a> ";
    ...
    while ($currentDay <= $numberDays) {
       ...
       if($date<date('Y-m-d')){
            ...
            if($totalbookings==20){
             ...
             $calendar.="<td class='$today'><h4>$currentDay</h4> <a href='booktable3.php?date=".$date."' class='btn btn-success btn-xs'>Book</a><small><i><b>$availableslot slot left</b></small></i>";
        }
    }
         $calendar .="</td>";
         $currentDay++;
...
function checkSlots($mysqli,$date){
    $stmt = $mysqli->prepare("select * from booking_bhopal_1_3 where date =? ");
