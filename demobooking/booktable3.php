...
if(isset($_POST['submit'])){
    ...
    if($stmt->execute()){
        ...
        // }
        {
            $stmt = $mysqli->prepare("INSERT INTO booking_bhopal_1_3 (name, email,phone,name2,name3 , date,timeslot,location,amount,table_size) VALUES (?,?,?,?,?,?,?,?,?,?)");
            $stmt->bind_param('ssssssssss', $name,  $email,$phone,$name2,$name3, $date,$timeslot,$book,$amount,$table_size);
            $stmt->execute();
