...
if(isset($_GET['date'])){
    $date = $_GET['date'];
    $stmt = $mysqli->prepare("select * FROM  booking_bhopal_1_12 where date = ?");
...
if(isset($_POST['submit'])){
    ...
    if($stmt->execute()){
        ...
        // }
        {
            $stmt = $mysqli->prepare("INSERT INTO booking_bhopal_1_12 (name, email,phone,name2,name3,name4,name5,name6,name7,name8,name9,name10 ,name11,name12, date,timeslot,location,amount,table_size) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            $stmt->bind_param('sssssssssssssssssss', $name,  $email,$phone,$name2,$name3,$name4,$name5,$name6,$name7,$name8,$name9,$name10,$name11,$name12, $date,$timeslot,$book,$amount,$table_size);
            $stmt->execute();
                        ...
                        <div class="col-md-12">
                            <form action="" method="post">
                               <div style="margin-left: 30px; margin-right: 30px; " class="form-group">
                                ...
                                <div style="margin-left: 30px; margin-right: 30px; " class="form-group">
                                    <label style="margin-left: 30px;" for="">Name 12 </label>
                                    <input required type="text" class="form-control" name="name12">
                                </div>
