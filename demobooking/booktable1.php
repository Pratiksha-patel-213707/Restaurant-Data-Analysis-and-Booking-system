...
if(isset($_POST['submit'])){
    ...
    if($stmt->execute()){
        ...
        // }
    {
            $stmt = $mysqli->prepare("INSERT INTO booking_bhopal_1_1 (name, email,phone, date,timeslot,location,amount,table_size) VALUES (?,?,?,?,?,?,?,?)");
            $stmt->bind_param('ssssssss', $name, $email,$phone, $date,$timeslot,$book,$amount,$table_size);
            $stmt->execute();
                        ...
                        <div class="col-md-12">
                            <form action="" method="post">
                               <div style="margin-left: 30px; margin-right: 30px; " class="form-group">
                                ...
                                <div  style="margin-left: 30px; margin-right: 30px; "  class="form-group">
                                    <label style="margin-left: 30px;" for="">Name</label>
