    ...
    while ($currentDay <= $numberDays) {
       ...
       if($date<date('Y-m-d')){
            ...
            if($totalbookings==30){
             ...
             $calendar.="<td class='$today'><h4>$currentDay</h4> <a href='booktable7.php?date=".$date."' class='btn btn-success btn-xs'>Book</a><small><i><b>$availableslot slot left</b></small></i>";
        }
    }
         $calendar .="</td>";
         $currentDay++;
...
function checkSlots($mysqli,$date){
    $stmt = $mysqli->prepare("select * from booking_bhopal_1_7 where date =? ");
