...
if(isset($_POST['submit'])){
    ...
    if($stmt->execute()){
        ...
        // }
        {
            $stmt = $mysqli->prepare("INSERT INTO booking_bhopal_1_7 (name, email,phone,name2,name3,name4,name5,name6,name7 , date,timeslot,location,amount,table_size) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            $stmt->bind_param('ssssssssssssss', $name,  $email,$phone,$name2,$name3,$name4,$name5,$name6,$name7, $date,$timeslot,$book,$amount,$table_size);
            $stmt->execute();
