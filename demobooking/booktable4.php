...
if(isset($_POST['submit'])){
    ...
    if($stmt->execute()){
        ...
        // }
        {
            $stmt = $mysqli->prepare("INSERT INTO booking_bhopal_1_4 (name, email,phone,name2,name3,name4 , date,timeslot,location,amount,table_size) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
            $stmt->bind_param('sssssssssss', $name,  $email,$phone,$name2,$name3,$name4, $date,$timeslot,$book,$amount,$table_size);
            $stmt->execute();
